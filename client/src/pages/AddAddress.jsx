...
const AddAddress = () => {
    ...
    const onSubmitHandler = async (e) => {
        ...
        try {
            const {data} = await axios.post('/api/address/add', {address: addressWithUserId});
  ...
  return (
    <div className='mt-16 pb-16'>
        <p className='text-2xl md:text-3xl text-gray-500'>Add Shipping <span className='font-demibold text-primary'>Address</span></p>
        <div className='flex flex-col-reverse md:flex-row justify-between mt-10'>
            ...
            <img className='md:mr-16 mb-14 md:mt-0' src={assets.add_address_iamge} alt="Add Address" />
        </div>
